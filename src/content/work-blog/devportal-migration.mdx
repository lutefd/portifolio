...
-   The prefetch was so agressive it would often cost a lot of money. The default behaviour at that time was to prefetch all the links on the page, that include tables with hundreds of items and the like. At the time I'm writing this, the default behaviour now is null, it's kind of funny that a boolean value defaults to null, but it's a good change. The docs say that this default amounts to this:
